...
from app.api.v1 import auth_router, skill_router, category_router, user_router, provider_router, bookings_router, search_router, urgent_router, review_router, admin_router, uploads_router
